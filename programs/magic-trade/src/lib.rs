...
declare_id!("FiSuahp9miHdU5CXGsGQNzuXQiCgyezFEhRPpJhfQSLM");
...
pub mod magic_trade {
    ...
    pub fn add_collateral_to_position(ctx: Context<AddCollateralToPosition>, amount: u64) -> Result<()> {
        add_collateral_to_position::handler(ctx, amount)
    }
